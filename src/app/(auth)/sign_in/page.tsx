...
import { signIn } from '../../lib/actions/auth_action'
      ...
      <div className="max-w-md w-full space-y-8">
          ...
          <div className="mt-6">
           ...
           <div className="mt-6">
             <div className="text-center mb-4">
               <span className="text-sm text-gray-500">Social sign-in coming soon</span>
             </div>
             <div className="grid grid-cols-2 gap-3">
               <button
                 type="button"
                 disabled
                 className="w-full inline-flex justify-center py-2 px-4 border border-gray-200 rounded-lg shadow-sm bg-gray-50 text-sm font-medium text-gray-400 cursor-not-allowed opacity-60"
               >
        ...
        <div className="text-center">
          <p className="text-gray-600">
            ...
            <Link href="/sign_up" className="font-medium text-blue-600 hover:text-blue-500">
              Sign up for free
            </Link>
          </p>
        </div>
